...
public class ContactInfo {
	...
	public static class Builder<HasFirstName, HasLastName, HasEmail> {
		...
		public Builder<True, HasLastName, HasEmail> setFirst(String first) {
			this.firstName = first;
			return (Builder<True, HasLastName, HasEmail>) this;
		}

		public Builder<HasFirstName, True, HasEmail> setLastName(String lastName) {
			this.lastName = lastName;
			return (Builder<HasFirstName, True, HasEmail>) this;
		}

		public Builder<HasFirstName, HasLastName, True> setEMail(String eMail) {
			this.eMail = eMail;
	...
	public void test(){
		...
		ContactInfo info = new ContactInfo(builder.setFirst("A").setLastName("B").setEMail("C"));
